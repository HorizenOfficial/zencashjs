...
function serializeTx(txObj) {
  ...
  txObj.outs.map(function (o) {
    ...
    _buf32 = zbufferutils.writeUInt64LE(_buf32, o.satoshis, 0); // ScriptPubKey
    ...
    for (var i = 0; i < txObj.vsc_ccout.length; i++) {
      ...
      if (sc_c.vFieldElementCertificateFieldConfig) {
        for (var _i2 = 0; _i2 < sc_c.vFieldElementCertificateFieldConfig.length; _i2++) {
          serializedTx += sc_c.vFieldElementCertificateFieldConfig[_i2].toString(16);
        }
      }

      var _c = Buffer.alloc(8);

      _c.writeUIntLE(255, 0, 4);

      _c.writeUIntLE(255, 4, 4);
      ...
      if (sc_c.vBitVectorCertificateFieldConfig) {
        ...
        for (var _i3 = 0; _i3 < sc_c.vBitVectorCertificateFieldConfig.length; _i3++) {
          ...
          _b2.writeUIntLE(sc_c.vBitVectorCertificateFieldConfig[_i3][bitVectorIdx], 0, 4);

          _b2.writeUIntLE(sc_c.vBitVectorCertificateFieldConfig[_i3][maxCompressedSizeIdx], 4, 4);
