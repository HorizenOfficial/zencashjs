...
function mkPubkeyHashReplayScript(address) {
    ...
    // '14' is the length of the subAddrHex (in bytes)
    return OP_DUP + OP_HASH160 + '14' + subAddrHex + OP_EQUALVERIFY + OP_CHECKSIG + blockHashLength + blockHashHex + blockHeightLength + blockHeightHex + OP_CHECKBLOCKATHEIGHT;
}
 ...
 */
function createRawTransaction(history, recipients) {
