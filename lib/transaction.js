...
function mkPubkeyHashReplayScript(address) {
  ...
  return OP_DUP + OP_HASH160 + getStringBufferLength(subAddrHex) + subAddrHex + OP_EQUALVERIFY + OP_CHECKSIG + getStringBufferLength(blockHashHex) + blockHashHex + getStringBufferLength(blockHeightHex) + blockHeightHex + OP_CHECKBLOCKATHEIGHT;
}
