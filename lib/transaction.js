...
var _require = require('./certificate'),
    deserializeCertFields = _require.deserializeCertFields;
...
function deserializeTx(hexStr) {
  ...
  if (version === zconstants.TX_VERSION_CERTIFICATE) {
    var _deserializeCertField = deserializeCertFields(buf, offset),
        _deserializeCertField2 = _slicedToArray(_deserializeCertField, 2),
        cert = _deserializeCertField2[0],
        _newOffset = _deserializeCertField2[1];
  ...
  if (version === zconstants.TX_VERSION_CERTIFICATE) {
    var _deserializeVout3 = deserializeVout(buf, offset, true),
        ...
        _newOffset2 = _deserializeVout4[1];
