...
it("serializeTx() and desrializeTx() should be deterministic", function () {
  const blockHash =
    "00000001cf4e27ce1dd8028408ed0a48edd445ba388170c9468ba0d42fff3052";
  ...
  var txobj_deserialized =
    zencashjs.transaction.deserializeTx(txobj_serialized);

  var txobj_serialized_full = zencashjs.transaction.serializeTx(txobj, true);
  var txobj_deserialized_full = zencashjs.transaction.deserializeTx(
    txobj_serialized_full,
    true
  );
  ...
  expect(txobj_serialized).to.equal(
...
it("signTx() should be deterministic", function () {
  ...
  const SIGHASH_ALL = 1;
  var signedobj = zencashjs.transaction.signTx(
    txobj,
    0,
  ...
  expect(signed_serialized).to.equal(
  ...
  signedobj = zencashjs.transaction.signTx(
    txobj_deserialized_full,
    0,
    "2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c",
    compressPubKey,
    SIGHASH_ALL
...
it("multiSign() for x-of-5 should be deterministic", function () {
  ...
  expect(redeemScript).to.equal(
    ""
  );
  ...
  var sig1 = zencashjs.transaction.multiSign(
    txobj,
    0,
    privKeys[2],
    redeemScript
  );
  var sig2 = zencashjs.transaction.multiSign(
    txobj,
    0,
    privKeys[3],
    redeemScript
  ...
  expect(sig1).to.equal(
    "3045022100d11cf82c7a8171a58f24291b82147cc1bb7f01b4ce2c903db504e72e787091c502203475b9fd239e09cfefc81505a9be6feb20b6e3f90a780ac2b0fd35d7a51ac50601"
  );
  expect(sig2).to.equal(
    "30440220330f82b8621d81b70c5e9e4af30259941ff477e330c7ed7d9802523a6c2747390220042dc8b0c01d543937b8eb80b9a94fc048c3f43f707f2f401941e4de48753d1701"
  );

  var tx0 = zencashjs.transaction.applyMultiSignatures(
    txobj,
    0,
    [sig1, sig2],
    redeemScript
  ...
  expect(serializedTx).to.equal(
    ""
  );
...
it("multiSign() and applyMultiSignatures() and should be deterministic", function () {
  var privKeysWIF = [
    ...
    "L5bpskJWAGGWR1GA9SJkCQ2ndHkezqm8GuoWaBesrrwnsa1roSN6",
    "L2sjwCsdZQmckKkTKGDqhKcWtbe3EU2FL4N1YHpD2SC1GhHRhqxF",
  ];
  ...
  expect(serializedTx).to.equal(
    ""
  );
  ...
  var deserializedTx = {
    ...
    ins: [
      {
        output: {
          hash: "f5f324064de9caab9353674c59f1c3987ca997bf5882a41a722686883e089581",
          vout: 0,
        },
        script:
          "",
        sequence: "ffffffff",
        prevScriptPubKey: "",
      },
    ],
    outs: [
      {
        satoshis: 10000,
        script:
          "76a914964f1832d9aa7e943d5dd8f84862393b935bbbad88ac205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4",
      },
    ],
  };

  expect(zencashjs.transaction.deserializeTx(serializedTx)).to.deep.equal(
    deserializedTx
  );
});
...
it("addressToScript should be deterministic for both P2SH and P2PKH on mainnet and testnet", function () {
  ...
  const blockHash =
    "00000001cf4e27ce1dd8028408ed0a48edd445ba388170c9468ba0d42fff3052";
  expect(
    zencashjs.transaction.addressToScript(addr1, blockHeight, blockHash, "")
  ).to.equal(
    "a914ed3f0f01c90f41ff665570d38f070c1ee8c075fe87205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4"
  );
  expect(
    zencashjs.transaction.addressToScript(addr2, blockHeight, blockHash, "")
  ).to.equal(
    "76a9143bc25502467ba509b9fb3680148a12b89c56247088ac205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4"
  );
  expect(
    zencashjs.transaction.addressToScript(addr3, blockHeight, blockHash, "")
  ).to.equal(
    "76a914ab523674d9f2ed5a0b300aeb072fc09801363f9f88ac205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4"
  );
});
...
it("deserializeTx() should properly deserialize certificate (transactions with version = -5)", function () {
  certificateTestData.forEach((certificate) => {
    ...
    const txobj_deserialized = zencashjs.transaction.deserializeTx(
      certificate.hex
    );
